...
package org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client;
 ...
 * generated in the org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _TranscriptInfoExons_QNAME = new QName("http://mutalyzer.nl/2.0/services", "exons");
    ...
    private final static QName _CheckSyntaxOutputMessages_QNAME = new QName("http://mutalyzer.nl/2.0/services", "messages");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client
     * 
     */
    ...
    public JAXBElement<ExonInfoArray> createTranscriptInfoExons(ExonInfoArray value) {
        return new JAXBElement<ExonInfoArray>(_TranscriptInfoExons_QNAME, ExonInfoArray.class, TranscriptInfo.class, value);
    }
    ...
    public JAXBElement<SoapMessageArray> createCheckSyntaxOutputMessages(SoapMessageArray value) {
        return new JAXBElement<SoapMessageArray>(_CheckSyntaxOutputMessages_QNAME, SoapMessageArray.class, CheckSyntaxOutput.class, value);
    }
    ...
    public JAXBElement<SoapMessageArray> createMappingMessages(SoapMessageArray value) {
        return new JAXBElement<SoapMessageArray>(_CheckSyntaxOutputMessages_QNAME, SoapMessageArray.class, Mapping.class, value);
    }
    ...
    public JAXBElement<SoapMessageArray> createMutalyzerOutputMessages(SoapMessageArray value) {
        return new JAXBElement<SoapMessageArray>(_CheckSyntaxOutputMessages_QNAME, SoapMessageArray.class, MutalyzerOutput.class, value);
    }
    ...
    public JAXBElement<ExonInfoArray> createMutalyzerOutputExons(ExonInfoArray value) {
        return new JAXBElement<ExonInfoArray>(_TranscriptInfoExons_QNAME, ExonInfoArray.class, MutalyzerOutput.class, value);
    }
