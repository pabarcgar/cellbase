...
public interface Mutalyzer {
     ...
     * @param variant
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.Mapping
     */
    @WebMethod(action = "mappingInfo")
    @WebResult(name = "mappingInfoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "mappingInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.MappingInfo")
    @ResponseWrapper(localName = "mappingInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.MappingInfoResponse")
     ...
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.TranscriptNameInfo
     */
    ...
    @RequestWrapper(localName = "getGeneAndTranscript", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetGeneAndTranscript")
    @ResponseWrapper(localName = "getGeneAndTranscriptResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetGeneAndTranscriptResponse")
     ...
     * @param genomicReference
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.TranscriptInfoArray
     */
    ...
    @RequestWrapper(localName = "getTranscriptsAndInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsAndInfo")
    @ResponseWrapper(localName = "getTranscriptsAndInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsAndInfoResponse")
     ...
     * @param variant
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.StringArray
     */
    @WebMethod(action = "numberConversion")
    @WebResult(name = "numberConversionResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "numberConversion", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.NumberConversion")
    @ResponseWrapper(localName = "numberConversionResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.NumberConversionResponse")
    ...
    @RequestWrapper(localName = "getTranscriptsByGeneName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsByGeneName")
    @ResponseWrapper(localName = "getTranscriptsByGeneNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsByGeneNameResponse")
    ...
    @RequestWrapper(localName = "uploadGenBankRemoteFile", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.UploadGenBankRemoteFile")
    @ResponseWrapper(localName = "uploadGenBankRemoteFileResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.UploadGenBankRemoteFileResponse")
    ...
    @RequestWrapper(localName = "ping", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.Ping")
    @ResponseWrapper(localName = "pingResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.PingResponse")
    public String ping();
    ...
    @RequestWrapper(localName = "sliceChromosome", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SliceChromosome")
    @ResponseWrapper(localName = "sliceChromosomeResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SliceChromosomeResponse")
    ...
    @RequestWrapper(localName = "submitBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SubmitBatchJob")
    @ResponseWrapper(localName = "submitBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SubmitBatchJobResponse")
    ...
    @RequestWrapper(localName = "uploadGenBankLocalFile", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.UploadGenBankLocalFile")
    @ResponseWrapper(localName = "uploadGenBankLocalFileResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.UploadGenBankLocalFileResponse")
    ...
    @RequestWrapper(localName = "chromAccession", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.ChromAccession")
    @ResponseWrapper(localName = "chromAccessionResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.ChromAccessionResponse")
     ...
     * @param variant
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.CheckSyntaxOutput
     */
    @WebMethod(action = "checkSyntax")
    @WebResult(name = "checkSyntaxResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "checkSyntax", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.CheckSyntax")
    @ResponseWrapper(localName = "checkSyntaxResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.CheckSyntaxResponse")
    ...
    @RequestWrapper(localName = "getGeneName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetGeneName")
    @ResponseWrapper(localName = "getGeneNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetGeneNameResponse")
     ...
     * @param build
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.Transcript
     */
    @WebMethod(action = "transcriptInfo")
    @WebResult(name = "transcriptInfoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "transcriptInfo", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.TranscriptInfoByNM")
    @ResponseWrapper(localName = "transcriptInfoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.TranscriptInfoResponse")
    ...
    @RequestWrapper(localName = "getdbSNPDescriptions", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetdbSNPDescriptions")
    @ResponseWrapper(localName = "getdbSNPDescriptionsResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetdbSNPDescriptionsResponse")
     ...
     * @param reference
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.Allele
     */
    ...
    @RequestWrapper(localName = "descriptionExtract", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.DescriptionExtract")
    @ResponseWrapper(localName = "descriptionExtractResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.DescriptionExtractResponse")
    ...
    @RequestWrapper(localName = "getchromName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetchromName")
    @ResponseWrapper(localName = "getchromNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetchromNameResponse")
     ...
     * @param variant
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.MutalyzerOutput
     */
    @WebMethod(action = "runMutalyzer")
    @WebResult(name = "runMutalyzerResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "runMutalyzer", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.RunMutalyzer")
    @ResponseWrapper(localName = "runMutalyzerResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.RunMutalyzerResponse")
     ...
     * @param chrom
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.TranscriptMappingInfoArray
     */
    ...
    @RequestWrapper(localName = "getTranscriptsMapping", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsMapping")
    @ResponseWrapper(localName = "getTranscriptsMappingResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsMappingResponse")
    ...
    @RequestWrapper(localName = "getBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetBatchJob")
    @ResponseWrapper(localName = "getBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetBatchJobResponse")
     ...
     * @param createdSince
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.CacheEntryArray
     */
    @WebMethod(action = "getCache")
    @WebResult(name = "getCacheResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "getCache", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetCache")
    @ResponseWrapper(localName = "getCacheResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetCacheResponse")
    ...
    @RequestWrapper(localName = "getTranscripts", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscripts")
    @ResponseWrapper(localName = "getTranscriptsResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsResponse")
     ...
     * 
     * @return
     *     returns org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.InfoOutput
     */
    @WebMethod(action = "info")
    @WebResult(name = "infoResult", targetNamespace = "http://mutalyzer.nl/2.0/services")
    @RequestWrapper(localName = "info", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.Info")
    @ResponseWrapper(localName = "infoResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.InfoResponse")
    ...
    @RequestWrapper(localName = "sliceChromosomeByGene", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SliceChromosomeByGene")
    @ResponseWrapper(localName = "sliceChromosomeByGeneResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.SliceChromosomeByGeneResponse")
    ...
    @RequestWrapper(localName = "getTranscriptsRange", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsRange")
    @ResponseWrapper(localName = "getTranscriptsRangeResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.GetTranscriptsRangeResponse")
    ...
    @RequestWrapper(localName = "chromosomeName", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.ChromosomeName")
    @ResponseWrapper(localName = "chromosomeNameResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.ChromosomeNameResponse")
    ...
    @RequestWrapper(localName = "monitorBatchJob", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.MonitorBatchJob")
    @ResponseWrapper(localName = "monitorBatchJobResponse", targetNamespace = "http://mutalyzer.nl/2.0/services", className = "org.opencb.cellbase.build.transform.formats.mutalyzer.ws.client.MonitorBatchJobResponse")
