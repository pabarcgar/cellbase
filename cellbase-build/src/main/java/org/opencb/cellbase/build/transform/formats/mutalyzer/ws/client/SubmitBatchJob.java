...
/**
 * <p>Java class for submitBatchJob complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="submitBatchJob">
 *   &lt;complexContent>
...
@XmlType(name = "submitBatchJob", propOrder = {
    "data",
    "process",
    "argument"
})
public class SubmitBatchJob {

    @XmlElement(required = true)
    protected byte[] data;
    @XmlElementRef(name = "process", namespace = "http://mutalyzer.nl/2.0/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> process;
    @XmlElementRef(name = "argument", namespace = "http://mutalyzer.nl/2.0/services", type = JAXBElement.class, required = false)
