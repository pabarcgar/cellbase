 ...
 *         &lt;element name="announcementUrl" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class InfoOutput {
    ...
    @XmlElementRef(name = "announcement", namespace = "http://mutalyzer.nl/2.0/services", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "announcementUrl", namespace = "http://mutalyzer.nl/2.0/services", type = JAXBElement.class, required = false)
    protected JAXBElement<String> announcementUrl;
     ...
     *     
     */
    public JAXBElement<String> getAnnouncementUrl() {
     ...
     *     
     */
    public void setAnnouncementUrl(JAXBElement<String> value) {
