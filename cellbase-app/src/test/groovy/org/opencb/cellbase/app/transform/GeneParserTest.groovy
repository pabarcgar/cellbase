...
class GeneParserTest extends Specification {
    ...
    def "transcript #transcriptId from gene #geneId parsed"() {
        ...
        "rna62139"        || "gene23264"       | "NR_026822.1"    | "lincRNA" | "9"        | 34394 | 34957 | "-"    | 2           | 5
    }
    ...
    def "exon #exonId from transcript #transcriptId parsed"() {
        ...
        "id696925"        || "gene23264"       | "rna62139"        | "9"        | 35504 | 35864 | "-"    | "???" | "???"
        "id696926"        || "gene23264"       | "rna62139"        | "9"        | 35060 | 35264 | "-"    | "???" | "???"
        "id696927"        || "gene23264"       | "rna62139"        | "9"        | 34394 | 34957 | "-"    | "???" | "???"
    }
